...
-- Luego añadir la clave foránea hacia categories
...
INSERT INTO project_categories (project_id, category_id) VALUES
    (1, 1), -- Community Health Fair → Health
    (2, 2), -- School Renovation → Education
    (3, 3), -- Food Distribution → Employment
    (4, 4), -- Tech Workshop → Culture
    (5, 5), -- Environmental Cleanup → Environment
    (6, 1), -- Vaccination Campaign → Health
    (7, 2); -- Library Expansion → Education

SELECT sp.title, o.name AS organization, c.name AS category
