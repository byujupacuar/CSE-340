-- 1. Crear tablas independientes (Padres)
...
-- 2. Crear tabla dependiente (Hijo) con todas sus relaciones
...
-- 3. Insertar datos en las tablas independientes
...
-- 4. Insertar datos en la tabla dependiente al final
-- Organization 1 projects
INSERT INTO service_projects (organization_id, title, description, location, project_date, status, category_id) VALUES
